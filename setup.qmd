...
If you have trouble installing {air}, we have installed the {styler} R package before, which does the same thing, just not as fast.
...
<!-- TODO If time, make a gif of this -->
...
![](figs/rstudio-download-rbp-exercises.png)

Then, unzip that, and click on the rbp-exercises.Rproj file:

![](figs/rstudio-show-rbp-rpoj.png)
