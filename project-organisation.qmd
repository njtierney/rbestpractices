...
Go to [course exercises](setup.qmd#sec-rbp-exercises) and follow the instructions on downloading the course materials.
...
Now when you restart R, it will always give you a clean session. You should make a habit of restarting R and starting from scratch. If your code works from a clean session, you know it will work. And, if it doesn't work in a new session, you know you have a bug you need to solve.

There is even a keyboard shortcut to restart R - worth knowing about:
