...
This chapter is about the **reprex**, which is short for **repr**oducible **ex**ample. If you can demonstrate how you are stuck, you often solve the problem in the process of creating that demonstration. Then, if you can't, you have made it easier for someone else to see how your are stuck. That makes it easier for them to help you.
...
![](figs/reprex-show-copy-mean.png)
...
Use `"Ctrl+Shift+R"` on Windows or Linux. This one is lifted straight from [Positron's own documentation](https://positron.posit.co/keyboard-shortcuts.html), where reprex is the worked example. If you'd rather not bind anything, the palette also has **R: Run RStudio Addin**, which lists reprex alongside every other addin you have installed.
...
It is sort of the same experience as describing a problem out loud to a colleague, and then by the time you've explained it, you manage to solve it. This is a whole concept called ["rubber duck debugging"](https://en.wikipedia.org/wiki/Rubber_duck_debugging) I have a rubby ducky on my desk for this purpose. You take your rubber ducky and explain the problem to then.
